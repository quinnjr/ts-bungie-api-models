...
import { UnlockStatus } from '../../Unlock/UnlockStatus';
import { ItemState } from '../../Vendor/ItemState';
import { ItemStatus } from '../../Vendor/ItemStatus';
...
export interface SaleItemComponent {
   ...
   */
  saleStatus?: ItemStatus;
  /**
   * A summary of the current costs of the item.
   */
  costs?: Array<ItemQuantity>;
  /**
   ...
   */
  unlockStatuses?: Array<UnlockStatus>;
  /**
